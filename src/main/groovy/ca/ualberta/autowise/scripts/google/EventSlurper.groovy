...
static def slurpSheet(GoogleAPI googleAPI, spreadsheetId){
    ...
    def staticSingleValues = [
            ...
            "executiveRatio": "Event!B13",
            "campaignStartOffset": "Event!B14",
            "resolicitFrequency": "Event!B15",
            "followupOffset": "Event!B16",
            "recruitmentEmailTemplateId": "Event!B17",
            "followupEmailTemplateId": "Event!B18",
            "confirmAssignedEmailTemplateId": "Event!B19",
            "confirmCancelledEmailTemplateId": "Event!B20",
            "confirmWaitlistEmailTemplateId": "Event!B21",
            "confirmRejectedEmailTemplateId": "Event!B22",
    ]
