...
|%REJECT_LINK% | A link that allows volunteers to reject all volunteering opportunities for this event so they will no longer be contacted in subsequent reminder recruitment emails for *this* event only. | [Click me if you aren't able to volunteer for this event.]()|
